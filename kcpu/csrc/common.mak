...
# NOTE: if the .d file generation references a missing header, that's going to result
#       in infinite .d file regeneration loop. That's because all the headers listed in the .d file
#       are made a dependency of the .d file (such that the .d file gets correctly rebuilt if the
#       include chain changes anywhere).
