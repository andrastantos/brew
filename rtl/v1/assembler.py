...
def r_eq_r_xor_r(     rD, rA,  rB):  _prog(_asm.r_eq_r_xor_r(     _r(rD), _r(rB), _r(rA)))
def r_eq_r_or_r(      rD, rA,  rB):  _prog(_asm.r_eq_r_or_r(      _r(rD), _r(rB), _r(rA)))
def r_eq_r_and_r(     rD, rA,  rB):  _prog(_asm.r_eq_r_and_r(     _r(rD), _r(rB), _r(rA)))
def r_eq_r_plus_r(    rD, rA,  rB):  _prog(_asm.r_eq_r_plus_r(    _r(rD), _r(rB), _r(rA)))
def r_eq_r_minus_r(   rD, rA,  rB):  _prog(_asm.r_eq_r_minus_r(   _r(rD), _r(rB), _r(rA)))
def r_eq_r_shl_r(     rD, rA,  rB):  _prog(_asm.r_eq_r_shl_r(     _r(rD), _r(rB), _r(rA)))
def r_eq_r_shr_r(     rD, rA,  rB):  _prog(_asm.r_eq_r_shr_r(     _r(rD), _r(rB), _r(rA)))
def r_eq_r_sar_r(     rD, rA,  rB):  _prog(_asm.r_eq_r_sar_r(     _r(rD), _r(rB), _r(rA)))
def r_eq_r_mul_r(     rD, rA,  rB):  _prog(_asm.r_eq_r_mul_r(     _r(rD), _r(rB), _r(rA)))
def r_eq_not_r_and_r( rD, rA,  rB):  _prog(_asm.r_eq_not_r_and_r( _r(rD), _r(rB), _r(rA)))
