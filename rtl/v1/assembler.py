...
class DecodeExpectations(object):
    def swi(self, swi): return ExecExp(exec_unit=op_class.branch)
    def stm(self): ExecExp(exec_unit=op_class.branch)
    def woi(self): ExecExp(exec_unit=op_class.alu)
    def sii(self): ExecExp(exec_unit=op_class.branch)
    def r_eq_r_xor_r(self,     rD = None, rA = None,  rB = None): return ExecExp(exec_unit=op_class.alu)
    def r_eq_r_or_r(self,      rD = None, rA = None,  rB = None): return ExecExp(exec_unit=op_class.alu)
    def r_eq_r_and_r(self,     rD = None, rA = None,  rB = None): return ExecExp(exec_unit=op_class.alu)
    def r_eq_r_plus_r(self,    rD = None, rA = None,  rB = None): return ExecExp(exec_unit=op_class.alu)
    def r_eq_r_minus_r(self,   rD = None, rA = None,  rB = None): return ExecExp(exec_unit=op_class.alu)
    def r_eq_r_shl_r(self,     rD = None, rA = None,  rB = None): return ExecExp(exec_unit=op_class.shift)
    def r_eq_r_shr_r(self,     rD = None, rA = None,  rB = None): return ExecExp(exec_unit=op_class.shift)
    def r_eq_r_sar_r(self,     rD = None, rA = None,  rB = None): return ExecExp(exec_unit=op_class.shift)
    def r_eq_r_mul_r(self,     rD = None, rA = None,  rB = None): return ExecExp(exec_unit=op_class.mult)
    def r_eq_not_r_and_r(self, rD = None, rA = None,  rB = None): return ExecExp(exec_unit=op_class.alu)
    def r_eq_r_plus_t(self,    rD = None, rB = None,  imm = None): return ExecExp(exec_unit=op_class.alu)

    def r_eq_I_xor_r(self,   rD = None, imm = None, rB = None): return ExecExp(exec_unit=op_class.alu)
    def r_eq_I_or_r(self,    rD = None, imm = None, rB = None): return ExecExp(exec_unit=op_class.alu)
    def r_eq_I_and_r(self,   rD = None, imm = None, rB = None): return ExecExp(exec_unit=op_class.alu)
    def r_eq_I_plus_r(self,  rD = None, imm = None, rB = None): return ExecExp(exec_unit=op_class.alu)
    def r_eq_I_minus_r(self, rD = None, imm = None, rB = None): return ExecExp(exec_unit=op_class.alu)
    def r_eq_I_shl_r(self,   rD = None, imm = None, rB = None): return ExecExp(exec_unit=op_class.shift)
    def r_eq_I_shr_r(self,   rD = None, imm = None, rB = None): return ExecExp(exec_unit=op_class.shift)
    def r_eq_I_sar_r(self,   rD = None, imm = None, rB = None): return ExecExp(exec_unit=op_class.shift)
    def r_eq_I_mul_r(self,   rD = None, imm = None, rB = None): return ExecExp(exec_unit=op_class.mult)

    def r_eq_i_xor_r(self,   rD = None, imm = None, rA = None): return ExecExp(exec_unit=op_class.alu)
    def r_eq_i_or_r(self,    rD = None, imm = None, rA = None): return ExecExp(exec_unit=op_class.alu)
    def r_eq_i_and_r(self,   rD = None, imm = None, rA = None): return ExecExp(exec_unit=op_class.alu)
    def r_eq_i_plus_r(self,  rD = None, imm = None, rA = None): return ExecExp(exec_unit=op_class.alu)
    def r_eq_i_minus_r(self, rD = None, imm = None, rA = None): return ExecExp(exec_unit=op_class.alu)
    def r_eq_i_shl_r(self,   rD = None, imm = None, rA = None): return ExecExp(exec_unit=op_class.shift)
    def r_eq_i_shr_r(self,   rD = None, imm = None, rA = None): return ExecExp(exec_unit=op_class.shift)
    def r_eq_i_sar_r(self,   rD = None, imm = None, rA = None): return ExecExp(exec_unit=op_class.shift)
    def r_eq_i_mul_r(self,   rD = None, imm = None, rA = None): return ExecExp(exec_unit=op_class.mult)

    def fence(self): return ExecExp(exec_unit=op_class.alu)
    def pc_eq_r(self, rD = None): return ExecExp(exec_unit=op_class.branch)
    def tpc_eq_r(self, rD = None): return ExecExp(exec_unit=op_class.branch)
    def r_eq_pc(self, rD = None): return ExecExp(exec_unit=op_class.alu)
    def r_eq_tpc(self, rD = None): return ExecExp(exec_unit=op_class.alu)
    def r_eq_t(self, rD = None, imm = None): return ExecExp(exec_unit=op_class.alu)
    def r_eq_pc_plus_t(self, rD = None, imm = None): return ExecExp(exec_unit=op_class.alu)
    def r_eq_neg_r(self, rD = None, rA = None): return ExecExp(exec_unit=op_class.alu)
    def r_eq_not_r(self, rD = None, rA = None): return ExecExp(exec_unit=op_class.alu)
    def r_eq_bse_r(self, rD = None, rA = None): return ExecExp(exec_unit=op_class.alu)
    def r_eq_wse_r(self, rD = None, rA = None): return ExecExp(exec_unit=op_class.alu)

    def r_eq_I(self, rD = None, imm = None): return ExecExp(exec_unit=op_class.alu)
    def pc_eq_I(self, imm = None): return ExecExp(exec_unit=op_class.branch)
    def tpc_eq_I(self, imm = None): return ExecExp(exec_unit=op_class.branch)
    def r_eq_i(self, rD = None, imm = None): return ExecExp(exec_unit=op_class.alu)
    def pc_eq_i(self, imm = None): return ExecExp(exec_unit=op_class.branch)
    def tpc_eq_i(self, imm = None): return ExecExp(exec_unit=op_class.branch)
    def if_r_eq_z(self,  rA = None, imm = None): return ExecExp(exec_unit=op_class.branch)
    def if_r_ne_z(self,  rA = None, imm = None): return ExecExp(exec_unit=op_class.branch)
    def if_r_lts_z(self, rA = None, imm = None): return ExecExp(exec_unit=op_class.branch)
    def if_r_ges_z(self, rA = None, imm = None): return ExecExp(exec_unit=op_class.branch)
    def if_r_gts_z(self, rA = None, imm = None): return ExecExp(exec_unit=op_class.branch)
    def if_r_les_z(self, rA = None, imm = None): return ExecExp(exec_unit=op_class.branch)
    def if_r_eq_r(self,  rB = None, rA = None, imm = None): return ExecExp(exec_unit=op_class.branch)
    def if_r_ne_r(self,  rB = None, rA = None, imm = None): return ExecExp(exec_unit=op_class.branch)
    def if_r_lts_r(self, rB = None, rA = None, imm = None): return ExecExp(exec_unit=op_class.branch)
    def if_r_ges_r(self, rB = None, rA = None, imm = None): return ExecExp(exec_unit=op_class.branch)
    def if_r_lt_r(self,  rB = None, rA = None, imm = None): return ExecExp(exec_unit=op_class.branch)
    def if_r_ge_r(self,  rB = None, rA = None, imm = None): return ExecExp(exec_unit=op_class.branch)
    def if_r_setb(self,  rA = None, bit = None, imm = None): return ExecExp(exec_unit=op_class.branch)
    def if_r_clrb(self,  rB = None, bit = None, imm = None): return ExecExp(exec_unit=op_class.branch)

    def mem32_r_plus_t_eq_r(self, rA = None, imm = None, rD = None): return ExecExp(exec_unit=op_class.ld_st)
    def r_eq_mem32_r_plus_t(self, rD = None, rA = None, imm = None): return ExecExp(exec_unit=op_class.ld_st)
    def r_eq_mem8_r(self, rD = None, rA = None): return ExecExp(exec_unit=op_class.ld_st)
    def r_eq_mem16_r(self, rD = None, rA = None): return ExecExp(exec_unit=op_class.ld_st)
    def r_eq_mem32_r(self, rD = None, rA = None): return ExecExp(exec_unit=op_class.ld_st)
    def r_eq_memll32_r(self, rD = None, rA = None): return ExecExp(exec_unit=op_class.ld_st)
    def mem8_r_eq_r(self, rA = None, rD = None): return ExecExp(exec_unit=op_class.ld_st)
    def mem16_r_eq_r(self, rA = None, rD = None): return ExecExp(exec_unit=op_class.ld_st)
    def mem32_r_eq_r(self, rA = None, rD = None): return ExecExp(exec_unit=op_class.ld_st)
    def memsr32_r_eq_r(self, rA = None, rD = None): return ExecExp(exec_unit=op_class.ld_st)
    def r_eq_smem8_r(self, rD = None, rA = None): return ExecExp(exec_unit=op_class.ld_st)
    def r_eq_smem16_r(self, rD = None, rA = None): return ExecExp(exec_unit=op_class.ld_st)

    def r_eq_mem8_r_plus_i(self, rD = None, rA = None, imm = None): return ExecExp(exec_unit=op_class.ld_st)
    def r_eq_mem16_r_plus_i(self, rD = None, rA = None, imm = None): return ExecExp(exec_unit=op_class.ld_st)
    def r_eq_mem32_r_plus_i(self, rD = None, rA = None, imm = None): return ExecExp(exec_unit=op_class.ld_st)
    def r_eq_memll32_r_plus_i(self, rD = None, rA = None, imm = None): return ExecExp(exec_unit=op_class.ld_st)
    def mem8_r_plus_i_eq_r(self, rA = None, imm = None, rD = None): return ExecExp(exec_unit=op_class.ld_st)
    def mem16_r_plus_i_eq_r(self, rA = None, imm = None, rD = None): return ExecExp(exec_unit=op_class.ld_st)
    def mem32_r_plus_i_eq_r(self, rA = None, imm = None, rD = None): return ExecExp(exec_unit=op_class.ld_st)
    def memsr32_r_plus_i_eq_r(self, rA = None, imm = None, rD = None): return ExecExp(exec_unit=op_class.ld_st)
    def r_eq_smem8_r_plus_i(self, rD = None, rA = None, imm = None): return ExecExp(exec_unit=op_class.ld_st)
    def r_eq_smem16_r_plus_i(self, rD = None, rA = None, imm = None): return ExecExp(exec_unit=op_class.ld_st)

    def r_eq_mem8_I(self, rD = None, imm = None): return ExecExp(exec_unit=op_class.ld_st)
    def r_eq_mem16_I(self, rD = None, imm = None): return ExecExp(exec_unit=op_class.ld_st)
    def r_eq_mem32_I(self, rD = None, imm = None): return ExecExp(exec_unit=op_class.ld_st)
    def r_eq_memll32_I(self, rD = None, imm = None): return ExecExp(exec_unit=op_class.ld_st)
    def mem8_I_eq_r(self, imm = None, rD = None): return ExecExp(exec_unit=op_class.ld_st)
    def mem16_I_eq_r(self, imm = None, rD = None): return ExecExp(exec_unit=op_class.ld_st)
    def mem32_I_eq_r(self, imm = None, rD = None): return ExecExp(exec_unit=op_class.ld_st)
    def memsr32_I_eq_r(self, imm = None, rD = None): return ExecExp(exec_unit=op_class.ld_st)
    def r_eq_smem8_I(self, rD = None, imm = None): return ExecExp(exec_unit=op_class.ld_st)
    def r_eq_smem16_I(self, rD = None, imm = None): return ExecExp(exec_unit=op_class.ld_st)

class BrewAssembler(object):
    def swi(self, swi): return (_inst(swi & 7, 0x0, 0x0, 0x0),)
    ...
    def mem32_r_plus_t_eq_r(self, rA = None, imm = None, rD = None):
        ...
        return (_inst(_r(rD), 0xc, field_ba >> 4, field_ba & 0xf),)
    def r_eq_mem32_r_plus_t(self, rD = None, rA = None, imm = None):
        rA = _r(rA)
        assert rA < 2
        field_ba = _to(imm) << 1 | rA
        return (_inst(_r(rD), 0xd, field_ba >> 4, field_ba & 0xf),)
