...
//#define SIM_TURBO // If enabled, removes all logging capability
//#define NO_ASSERTS // If enabled, removes all asserts from the code, by defining SIM_ASSERT as empty
