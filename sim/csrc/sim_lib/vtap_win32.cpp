...
TapAdapter_c::TapAdapter_c(TapAdapter_c &&aAdapter) {
	SIM_ASSERT((aAdapter.mReadOverlapped == nullptr) || (aAdapter.mReadOverlapped->Internal != STATUS_PENDING));
	SIM_ASSERT((aAdapter.mWriteOverlapped == nullptr) || (aAdapter.mWriteOverlapped->Internal != STATUS_PENDING));
