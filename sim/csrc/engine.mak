...
# 	$(file >$(OBJ_DIR)/$(addsuffix .d,$(basename $(notdir $(1)))),# THIS FILE GENERATED ERRORS)

define TEMPLATE
ifeq ($(suffix $(1)),.cpp)
$(OBJ_DIR)/$(addsuffix .d,$(basename $(notdir $(1)))): $(1)
	@-$(call MKDIR,$(OBJ_DIR)) $(NULL_REDIRECT)
	$(GCXX) $(DEP_CXXFLAGS) $(DEP_INC_FLAGS) $(DEFINE_FLAGS) -MM $$< -MP -MT $(OBJ_DIR)/$(addsuffix .d,$(basename $(notdir $(1)))) -MF $$@
...
$(OBJ_DIR)/$(addsuffix .d,$(basename $(notdir $(1)))): $(1)
	@-$(call MKDIR,$(OBJ_DIR)) $(NULL_REDIRECT)
	$(GCC) $(DEP_CFLAGS) $(DEP_INC_FLAGS) $(DEFINE_FLAGS) -MM $$< -MP -MT $(OBJ_DIR)/$(addsuffix .d,$(basename $(notdir $(1)))) -MF $$@
$(OBJ_DIR)/$(addsuffix .o,$(basename $(notdir $(1)))): $(1) $(OBJ_DIR)/$(addsuffix .d,$(basename $(notdir $(1)))) $(PROJECT_MAKEFILE)
	$(GCC) $(CFLAGS) $(INC_FLAGS) $(SYS_INC_FLAGS) $(DEFINE_FLAGS) $$< -c -g -o $$@
endif
endef
